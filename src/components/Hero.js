      ...
      <div className="hero-container">
        <div className="hero-content">
          <h1 className="hero-title">
            Hi, I'm <span className="highlight">Katta Aakash</span>
          </h1>
          ...
          <div className="hero-social">
            ...
            <a href="mailto:aakashaakash66666@gmail.com" aria-label="Email">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="hero-avatar">
            <div className="avatar-placeholder">
              <svg width="200" height="200" viewBox="0 0 200 200" fill="none">
                <circle cx="100" cy="100" r="100" fill="#3498db" opacity="0.1"/>
                <circle cx="100" cy="80" r="30" fill="#3498db"/>
                <ellipse cx="100" cy="140" rx="50" ry="40" fill="#3498db"/>
              </svg>
            </div>
          </div>
        </div>
